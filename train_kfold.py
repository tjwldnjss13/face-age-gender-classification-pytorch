...
from models.mobilenetv2_mini2_transfer import MobilenetV2MiniTransfer
from datasets.afad_dataset import AFADDataset
from datasets.augment import GaussianNoise
from loss import custom_weighted_focal_loss, custom_focal_loss, custom_age_gender_loss
...
if __name__ == '__main__':
    ...
    # Define model
    model_name = 'mobilenetv2mini2'
    state_dict_pth = None
    # state_dict_pth = 'pretrained models/_mobilenetv2mini2_afadfull_48+7epoch_5fold_1e-05lr_2.82251loss_0.23050lossage_2.59201lossgender_0.86777accage_0.49405accgender.pth'
    model = MobilenetV2Mini(dset_og.num_age_classes, 2).to(device)
    ...
    for e in range(num_epochs):
        ...
        # save_pth = f'saved models/{model_name}_{dset_name}_{e + 1}epoch_{fold + 1}fold_{learning_rate}lr_{val_loss_list[-1]:.5f}loss_' \
